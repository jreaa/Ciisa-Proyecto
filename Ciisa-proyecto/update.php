...
<main id="content" style="margin-top: 116px;">
	<div class="container">
		<div class="content">
			<div class="row">
				<div class="col-md-12">
					<div class="head_section">
						<h3>Productos</h3>
						<div><a href="addUser.php" class="btn btn-primary">Nuevo</a>
					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-hover">
								<div class="mb-3">
									<a href="index.php" style="border: 1px solid; padding: 0 8px; border-radius: 5px;"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-return-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
							  ...
							  <tbody>
							    <tr>
							      ...
							      <td>12.5$</td>
							      <td>25</td>
							      <td id="status">Manzanas grandes de color verde</td>
							      <td>
